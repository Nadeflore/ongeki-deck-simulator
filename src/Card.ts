...
export class Card {
     ...
     */
    public static fromJson(data: CardJson) {
        const card = new this()
     ...
     * @return base attack
     */
    public calculateBaseAttack(): number {
        let attack
     ...
     */
    public calculateSelfIncreasePercent(boss: boolean): number {
     ...
     */
    public calculateBoostPercents(boss: boolean): number[] {
     ...
     * @return attack
     */
    public calculateAttackWithSkills(boss: boolean): number {
        const baseAttack = this.calculateBaseAttack()
        let attack = baseAttack
        // Add self increase
        attack += baseAttack * this.calculateSelfIncreasePercent(boss) / 100
        // Add boosts
        for (const boostPercent of this.calculateBoostPercents(boss)) {
     ...
     */
    public compareAttribute(attribute: Attribute): number {
     ...
     */
    public calculateAttackAgainstEnemy(boss: boolean, attribute: Attribute) {
